class CountryCodeMapper {
  ...
  static String getIsoCode(String countryName) {
    ...
    switch (name) {
      ...
      case 'england': return 'GB-ENG'; // Inglaterra tem bandeira própria no pacote
      ...
      case 'turkey':
      case 'turkiye': return 'TR';
      case 'ukraine': return 'UA';
      case 'united states':
      case 'usa': return 'US';
      case 'uruguay': return 'UY';
      case 'wales': return 'GB-WLS'; // País de Gales tem bandeira própria
      case 'scotland': return 'GB-SCT'; // Escócia tem bandeira própria
      case 'northern ireland': return 'GB-NIR'; // Irlanda do Norte
      default:
